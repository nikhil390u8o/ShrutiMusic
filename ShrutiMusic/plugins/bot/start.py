...
async def start_pm(client, message: Message, _):
    ...
    if len(message.text.split()) > 1:
        ...
        if name[0:4] == "help":
            keyboard = help_pannel_page1(_)
            return await message.reply_photo(
                photo="https://files.catbox.moe/orqaah.jpg",
                caption=_["help_1"].format(config.SUPPORT_GROUP),
                #protect_content=True,
                reply_markup=keyboard,
            )
    ...
    for member in message.new_chat_members:
        try:
            ...
            if member.id == app.id:
                ...
                welcome_msg = """<b>⊚ 𝑇ℎ𝑖𝑠 𝑖𝑠 ˹ <b>𝅄 ꣑ৎ ࣪𝑆𝑜𝑙𝑎𝑟𝑎 𝑀𝑢𝑠𝑖𝑐𓂃 𓈒𓏸 ˼ ♪ [ 💌 ]

<b>➻ 𝐴 𝑃𝑟𝑒𝑚𝑖𝑢𝑚 𝐷𝑒𝑠𝑖𝑔𝑛𝑒𝑑 𝑀𝑢𝑠𝑖𝑐 𝑃𝑙𝑎𝑦𝑒𝑟 𝐵𝑜𝑡 𝑓𝑜𝑟 𝑇𝑒𝑙𝑒𝑔𝑟𝑎𝑚 𝐺𝑟𝑜𝑢𝑝 & 𝐶ℎ𝑎𝑛𝑛𝑒𝑙.

<b>:⧽ 𝐼𝑓 𝑦𝑜𝑢 𝑤𝑎𝑛𝑡 𝑎𝑛𝑦 ℎ𝑒𝑙𝑝 𝑡𝑎𝑝 𝑡𝑜 ℎ𝑒𝑙𝑝 𝑏𝑢𝑡𝑡𝑜𝑛 𝑓𝑜𝑟 𝑚𝑦 𝑚𝑜𝑑𝑢𝑙𝑒𝑠.</b>"""
                ...
                keyboard = InlineKeyboardMarkup([
                    ...
                    [
                        InlineKeyboardButton("Developer", url="https://t.me/NoxxOP"),  # Assuming developer's Telegram link
                        InlineKeyboardButton("Command Menu", callback_data="help_1")  # Assuming callback for command menu
                    ]
                ])
